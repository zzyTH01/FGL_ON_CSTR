...
> **适用范围(2026-08-06 修订):** 上述 0.76 **仅实测于 τ=100 混沌延迟 CSTR 单一数据集**(13 cells×3 seeds)。τ50/τ150 锚点(单点 L20H15)为 0.80/0.81,方向一致但非全网格;**未验证于原始周期1 CSTR(可比单点 ≈0.98)或 MG(E 干涸无意义)**。"76 折券"暂为延迟混沌 CSTR 家族内规律,跨数据集外推待方案 C 去混杂实验。
